...
public class MainFrame extends javax.swing.JFrame {
    ...
    private javax.swing.JLayeredPane bg = new JLayeredPane();
    ...
    private void init() {
        ...
        LoginView loginView = new LoginView(new LoginActionListener());
        SignUpView signUpView = new SignUpView(new SignUpActionListener());
