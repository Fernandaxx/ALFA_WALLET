...
public class PanelCover extends javax.swing.JPanel {
    ...
    private void init() {
        title = new JLabel("¡Bienvenido a ALFA WALLET!");
        ...
        add(description);
        description1 = new JLabel("¿Aun no tienes una cuenta?");
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        GradientPaint gra = new GradientPaint(0, 0, new Color(151, 10, 151), 0, getHeight(), new Color(94, 0, 94));
        g2.setPaint(gra);
